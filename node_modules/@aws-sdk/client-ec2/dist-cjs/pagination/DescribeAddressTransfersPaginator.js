...
exports.paginateDescribeAddressTransfers = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new DescribeAddressTransfersCommand_1.DescribeAddressTransfersCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.describeAddressTransfers(input, ...args);
};
async function* paginateDescribeAddressTransfers(config, input, ...additionalArguments) {

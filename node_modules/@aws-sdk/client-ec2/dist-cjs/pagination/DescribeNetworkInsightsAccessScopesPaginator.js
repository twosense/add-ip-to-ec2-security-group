...
exports.paginateDescribeNetworkInsightsAccessScopes = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new DescribeNetworkInsightsAccessScopesCommand_1.DescribeNetworkInsightsAccessScopesCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.describeNetworkInsightsAccessScopes(input, ...args);
};
async function* paginateDescribeNetworkInsightsAccessScopes(config, input, ...additionalArguments) {

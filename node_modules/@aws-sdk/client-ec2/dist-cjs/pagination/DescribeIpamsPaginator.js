...
exports.paginateDescribeIpams = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new DescribeIpamsCommand_1.DescribeIpamsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.describeIpams(input, ...args);
};
async function* paginateDescribeIpams(config, input, ...additionalArguments) {

...
exports.paginateDescribeIpamResourceDiscoveryAssociations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new DescribeIpamResourceDiscoveryAssociationsCommand_1.DescribeIpamResourceDiscoveryAssociationsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.describeIpamResourceDiscoveryAssociations(input, ...args);
};
async function* paginateDescribeIpamResourceDiscoveryAssociations(config, input, ...additionalArguments) {

...
exports.paginateDescribeIpamResourceDiscoveries = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new DescribeIpamResourceDiscoveriesCommand_1.DescribeIpamResourceDiscoveriesCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.describeIpamResourceDiscoveries(input, ...args);
};
async function* paginateDescribeIpamResourceDiscoveries(config, input, ...additionalArguments) {

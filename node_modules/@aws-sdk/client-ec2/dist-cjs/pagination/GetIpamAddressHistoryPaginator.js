...
exports.paginateGetIpamAddressHistory = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetIpamAddressHistoryCommand_1.GetIpamAddressHistoryCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getIpamAddressHistory(input, ...args);
};
async function* paginateGetIpamAddressHistory(config, input, ...additionalArguments) {

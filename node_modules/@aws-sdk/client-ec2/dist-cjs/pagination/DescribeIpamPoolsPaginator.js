...
exports.paginateDescribeIpamPools = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new DescribeIpamPoolsCommand_1.DescribeIpamPoolsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.describeIpamPools(input, ...args);
};
async function* paginateDescribeIpamPools(config, input, ...additionalArguments) {

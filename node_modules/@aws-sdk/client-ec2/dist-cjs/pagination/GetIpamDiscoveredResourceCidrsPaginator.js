...
exports.paginateGetIpamDiscoveredResourceCidrs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetIpamDiscoveredResourceCidrsCommand_1.GetIpamDiscoveredResourceCidrsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getIpamDiscoveredResourceCidrs(input, ...args);
};
async function* paginateGetIpamDiscoveredResourceCidrs(config, input, ...additionalArguments) {

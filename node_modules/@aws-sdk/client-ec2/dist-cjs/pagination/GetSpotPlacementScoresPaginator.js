...
exports.paginateGetSpotPlacementScores = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetSpotPlacementScoresCommand_1.GetSpotPlacementScoresCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getSpotPlacementScores(input, ...args);
};
async function* paginateGetSpotPlacementScores(config, input, ...additionalArguments) {

...
exports.paginateGetIpamPoolCidrs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetIpamPoolCidrsCommand_1.GetIpamPoolCidrsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getIpamPoolCidrs(input, ...args);
};
async function* paginateGetIpamPoolCidrs(config, input, ...additionalArguments) {

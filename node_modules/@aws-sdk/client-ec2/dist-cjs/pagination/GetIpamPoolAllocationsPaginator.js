...
exports.paginateGetIpamPoolAllocations = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetIpamPoolAllocationsCommand_1.GetIpamPoolAllocationsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getIpamPoolAllocations(input, ...args);
};
async function* paginateGetIpamPoolAllocations(config, input, ...additionalArguments) {

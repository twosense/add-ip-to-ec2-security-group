...
exports.paginateGetAwsNetworkPerformanceData = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetAwsNetworkPerformanceDataCommand_1.GetAwsNetworkPerformanceDataCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getAwsNetworkPerformanceData(input, ...args);
};
async function* paginateGetAwsNetworkPerformanceData(config, input, ...additionalArguments) {

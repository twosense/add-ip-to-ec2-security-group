...
exports.paginateDescribeNetworkInsightsAccessScopeAnalyses = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new DescribeNetworkInsightsAccessScopeAnalysesCommand_1.DescribeNetworkInsightsAccessScopeAnalysesCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.describeNetworkInsightsAccessScopeAnalyses(input, ...args);
};
async function* paginateDescribeNetworkInsightsAccessScopeAnalyses(config, input, ...additionalArguments) {

...
exports.paginateGetIpamDiscoveredAccounts = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetIpamDiscoveredAccountsCommand_1.GetIpamDiscoveredAccountsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getIpamDiscoveredAccounts(input, ...args);
};
async function* paginateGetIpamDiscoveredAccounts(config, input, ...additionalArguments) {

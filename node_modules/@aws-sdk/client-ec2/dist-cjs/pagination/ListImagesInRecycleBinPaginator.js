...
exports.paginateListImagesInRecycleBin = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new ListImagesInRecycleBinCommand_1.ListImagesInRecycleBinCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.listImagesInRecycleBin(input, ...args);
};
async function* paginateListImagesInRecycleBin(config, input, ...additionalArguments) {

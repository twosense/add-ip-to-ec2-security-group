...
exports.paginateGetInstanceTypesFromInstanceRequirements = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetInstanceTypesFromInstanceRequirementsCommand_1.GetInstanceTypesFromInstanceRequirementsCommand(input), ...args);
};
const makePagedRequest = async (client, input, ...args) => {
    return await client.getInstanceTypesFromInstanceRequirements(input, ...args);
};
async function* paginateGetInstanceTypesFromInstanceRequirements(config, input, ...additionalArguments) {

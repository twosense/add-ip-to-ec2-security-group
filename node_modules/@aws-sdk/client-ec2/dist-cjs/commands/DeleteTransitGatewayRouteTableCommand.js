...
class DeleteTransitGatewayRouteTableCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_3_1.DeleteTransitGatewayRouteTableRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_3_1.DeleteTransitGatewayRouteTableResultFilterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2DeleteTransitGatewayRouteTableCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2DeleteTransitGatewayRouteTableCommand)(output, context);
    }
}

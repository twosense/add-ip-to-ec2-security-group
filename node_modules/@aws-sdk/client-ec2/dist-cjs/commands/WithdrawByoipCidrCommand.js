...
class WithdrawByoipCidrCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_7_1.WithdrawByoipCidrRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_7_1.WithdrawByoipCidrResultFilterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2WithdrawByoipCidrCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2WithdrawByoipCidrCommand)(output, context);
    }
}

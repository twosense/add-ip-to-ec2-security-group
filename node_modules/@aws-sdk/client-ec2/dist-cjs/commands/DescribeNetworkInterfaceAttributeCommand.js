...
class DescribeNetworkInterfaceAttributeCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.DescribeNetworkInterfaceAttributeRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_4_1.DescribeNetworkInterfaceAttributeResultFilterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2DescribeNetworkInterfaceAttributeCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2DescribeNetworkInterfaceAttributeCommand)(output, context);
    }
}

...
class GetCapacityReservationUsageCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_5_1.GetCapacityReservationUsageRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_5_1.GetCapacityReservationUsageResultFilterSensitiveLog,
        };
        const { requestHandler } = configuration;
        return stack.resolve((request) => requestHandler.handle(request.request, options || {}), handlerExecutionContext);
    }
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2GetCapacityReservationUsageCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2GetCapacityReservationUsageCommand)(output, context);
    }
}

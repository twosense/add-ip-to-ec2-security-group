...
class DisableAddressTransferCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_5_1.DisableAddressTransferRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_5_1.DisableAddressTransferResultFilterSensitiveLog,
        };

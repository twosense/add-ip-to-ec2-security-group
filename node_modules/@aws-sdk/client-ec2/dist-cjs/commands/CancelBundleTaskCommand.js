...
class CancelBundleTaskCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.CancelBundleTaskRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2CancelBundleTaskCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2CancelBundleTaskCommand)(output, context);
    }
}

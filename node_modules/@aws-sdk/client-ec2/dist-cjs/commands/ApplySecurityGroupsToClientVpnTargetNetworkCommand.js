...
class ApplySecurityGroupsToClientVpnTargetNetworkCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ApplySecurityGroupsToClientVpnTargetNetworkRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2ApplySecurityGroupsToClientVpnTargetNetworkCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2ApplySecurityGroupsToClientVpnTargetNetworkCommand)(output, context);
    }
}

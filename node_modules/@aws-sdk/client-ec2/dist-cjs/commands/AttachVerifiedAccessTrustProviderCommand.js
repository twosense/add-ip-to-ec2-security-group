...
exports.AttachVerifiedAccessTrustProviderCommand = void 0;
...
class AttachVerifiedAccessTrustProviderCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.AttachVerifiedAccessTrustProviderRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2AttachVerifiedAccessTrustProviderCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2AttachVerifiedAccessTrustProviderCommand)(output, context);
    }
}

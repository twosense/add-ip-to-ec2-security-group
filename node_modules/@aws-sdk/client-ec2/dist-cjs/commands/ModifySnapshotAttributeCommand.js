...
class ModifySnapshotAttributeCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_6_1.ModifySnapshotAttributeRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_ec2_1.serializeAws_ec2ModifySnapshotAttributeCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_ec2_1.deserializeAws_ec2ModifySnapshotAttributeCommand)(output, context);
    }
}

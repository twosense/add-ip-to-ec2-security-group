 ...
 *
 */
export declare class ListSnapshotsInRecycleBinCommand extends $Command<ListSnapshotsInRecycleBinCommandInput, ListSnapshotsInRecycleBinCommandOutput, EC2ClientResolvedConfig> {
    readonly input: ListSnapshotsInRecycleBinCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    constructor(input: ListSnapshotsInRecycleBinCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: EC2ClientResolvedConfig, options?: __HttpHandlerOptions): Handler<ListSnapshotsInRecycleBinCommandInput, ListSnapshotsInRecycleBinCommandOutput>;
    private serialize;
    private deserialize;
}

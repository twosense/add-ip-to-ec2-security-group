 ...
 * @internal
 */
export declare const DisassociateIpamResourceDiscoveryRequestFilterSensitiveLog: (obj: DisassociateIpamResourceDiscoveryRequest) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const GetIpamDiscoveredAccountsRequestFilterSensitiveLog: (obj: GetIpamDiscoveredAccountsRequest) => any;
/**
 * @internal
 */
export declare const IpamDiscoveryFailureReasonFilterSensitiveLog: (obj: IpamDiscoveryFailureReason) => any;
/**
 * @internal
 */
export declare const IpamDiscoveredAccountFilterSensitiveLog: (obj: IpamDiscoveredAccount) => any;
/**
 * @internal
 */
export declare const GetIpamDiscoveredAccountsResultFilterSensitiveLog: (obj: GetIpamDiscoveredAccountsResult) => any;
/**
 * @internal
 */
export declare const GetIpamDiscoveredResourceCidrsRequestFilterSensitiveLog: (obj: GetIpamDiscoveredResourceCidrsRequest) => any;
/**
 * @internal
 */
export declare const IpamDiscoveredResourceCidrFilterSensitiveLog: (obj: IpamDiscoveredResourceCidr) => any;
/**
 * @internal
 */
export declare const GetIpamDiscoveredResourceCidrsResultFilterSensitiveLog: (obj: GetIpamDiscoveredResourceCidrsResult) => any;
/**
 * @internal
 */
